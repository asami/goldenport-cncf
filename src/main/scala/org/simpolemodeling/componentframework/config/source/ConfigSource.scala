package org.simplemodeling.componentframework.config.source

import java.nio.file.Path

import org.simplemodeling.componentframework.config.model.{Config, ConfigValue}
import org.simplemodeling.componentframework.config.trace.ConfigOrigin
import org.simplemodeling.Consequence
import org.simplemodeling.componentframework.config.source.file.FileConfigLoader
import org.simplemodeling.componentframework.config.source.file.SimpleFileConfigLoader
