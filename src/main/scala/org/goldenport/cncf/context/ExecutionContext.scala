...
import org.goldenport.id.{DefaultUniversalIdGenerator, EntropySource, UniversalId as CoreUniversalId}
...
object ExecutionContext {
  ...
  private def _observability_context(
    ...
    val id = generator.generate("cncf", "execution-context", "test", core.clock)
    ObservabilityContext(
      traceId = TraceId(id),
      spanId = None,
