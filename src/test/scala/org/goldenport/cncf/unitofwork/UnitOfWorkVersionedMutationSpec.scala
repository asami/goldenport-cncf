  ...
  "UnitOfWork Entity versioned mutation" should {
    "route provider-native and guarded patches" which {
      "use acknowledgment-only native mutation for an unversioned internal patch" in {
        ...
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "native_acknowledgment", _collectionid, entropy = "native_acknowledgment")
      ...
      "route an ordinary managed patch directly and reconcile its authoritative result" in {
        ...
        val fixture             = _fixture(EntityConcurrencyPolicy.None, datastore)
        given ExecutionContext  = fixture.context
        val id                  = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "native_direct", _collectionid, entropy = "native_direct")
        val interpreter         = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val authorization =
          Some(
            UnitOfWorkAuthorization(
      ...
      "route a managed optimistic patch through native compare-and-set after one revision load" in {
        ...
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "native_managed_cas", _collectionid, entropy = "native_managed_cas")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val created = interpreter.interpret(
          UnitOfWorkOp.EntityStoreCreate(
            VersionedPersonCreate(id, "before"),
      ...
      "route an observed managed patch through compare-and-set and evict stale resident state" in {
        ...
        val fixture            = _fixture(EntityConcurrencyPolicy.Optimistic, datastore)
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "native_cas", _collectionid, entropy = "native_cas")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val authorization =
          Some(
            UnitOfWorkAuthorization(
      ...
      "preserve logical deletion while using the provider-native patch route" in {
        ...
        val fixture            = _fixture(EntityConcurrencyPolicy.None, datastore)
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "native_deleted", _collectionid, entropy = "native_deleted")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val authorization =
          Some(
            UnitOfWorkAuthorization(
      ...
      "retain one authorization read while avoiding an EntityStore duplicate read" in {
        ...
        val fixture            = _fixture(EntityConcurrencyPolicy.None, datastore)
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "native_authorized", _collectionid, entropy = "native_authorized")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val authorization =
          Some(
            UnitOfWorkAuthorization(
      ...
      "preserve the authorization-loaded managed base revision through native compare-and-set" in {
        ...
        val fixture            = _fixture(EntityConcurrencyPolicy.Optimistic, datastore)
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "authorized_managed_base", _collectionid, entropy = "authorized_managed_base")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val authorization =
          Some(
            UnitOfWorkAuthorization(
      ...
      "preserve a validated missing managed base when the target is concurrently created" in {
        ...
        given ExecutionContext = fixture.context
        val id = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "validated_missing_base", _collectionid, entropy = "validated_missing_base")
        val interpreter =
      ...
      "keep WriteIfChanged on the guarded business-state path" in {
        ...
        val fixture            = _fixture(EntityConcurrencyPolicy.None, datastore)
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "guarded_write_if_changed", _collectionid, entropy = "guarded_write_if_changed")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val created = interpreter.interpret(
          UnitOfWorkOp.EntityStoreCreate(
            VersionedPersonCreate(id, "before"),
      ...
      "fall back to guarded mutation when the provider lacks native capability" in {
        ...
        val fixture            = _fixture(EntityConcurrencyPolicy.None, datastore)
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "guarded_provider", _collectionid, entropy = "guarded_provider")
        val interpreter        = new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val created = interpreter.interpret(
          UnitOfWorkOp.EntityStoreCreate(
            VersionedPersonCreate(id, "before"),
    ...
    "reconcile authoritative and resident Entity state" which {
      "decode an embedded create result before installing it in the working set" in {
        ...
        val fixture            = _fixture()
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "created", _collectionid, entropy = "created")
        val interpreter =
          new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
      ...
      "install an authoritative embedded patch result without an extra reload" in {
        ...
        val fixture            = _fixture()
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "embedded_patch", _collectionid, entropy = "embedded_patch")
        val interpreter =
          new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val created = interpreter.interpret(
          UnitOfWorkOp.EntityStoreCreate(
      ...
      "return and install the authoritative snapshot only after provider success" in {
        ...
        val fixture            = _fixture()
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "authoritative", _collectionid, entropy = "authoritative")
      ...
      "evict a stale resident without replacing authoritative storage" in {
        ...
        val fixture            = _fixture()
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "stale", _collectionid, entropy = "stale")
        val initial            = VersionedPerson(id, "before")
        val _ = fixture.datastorespace.inject(
          DataStore.CollectionId.EntityStore(_collectionid),
          _persistent.toStoreRecord(initial)
      ...
      "evict resident state when projection fails after the provider committed" in {
        ...
        val fixture            = _fixture()
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "projection_failure", _collectionid, entropy = "projection_failure")
        val initial            = VersionedPerson(id, "before")
        val _ = fixture.datastorespace.inject(
          DataStore.CollectionId.EntityStore(_collectionid),
          _persistent.toStoreRecord(initial)
    ...
    "preserve managed-save and admission policies" which {
      "preserve managed-save write and assembled concurrency policies" in {
        ...
        val fixture = _fixture()
        given ExecutionContext = fixture.context
        val id = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "managed_policy", _collectionid, entropy = "managed_policy")
        val initial = VersionedPerson(id, "before")
        val interpreter =
          new UnitOfWorkInterpreter(new UnitOfWork(fixture.context))
        val created = interpreter.interpret(
      ...
      "classify managed-save decoding failure after provider commit" in {
        ...
        val fixture = _fixture()
        given ExecutionContext = fixture.context
        val id = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "managed_projection_failure", _collectionid, entropy = "managed_projection_failure")
        val initial = VersionedPerson(id, "before")
        val _ = fixture.datastorespace.inject(
          DataStore.CollectionId.EntityStore(_collectionid),
          _persistent.toStoreRecord(initial)
      ...
      "preserve explicit optimistic policy through a None-policy collection" in {
        ...
        given ExecutionContext = fixture.context
        val id = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "explicit_optimistic", _collectionid, entropy = "explicit_optimistic")
        val initial = VersionedPerson(id, "before")
        val _ = fixture.datastorespace.inject(
          DataStore.CollectionId.EntityStore(_collectionid),
          _persistent.toStoreRecord(initial)
      ...
      "reject an unversioned framework mutation without System admission" in {
        ...
        val fixture            = _fixture()
        given ExecutionContext = fixture.context
        val id                 = org.goldenport.cncf.EntityIdFixtureBridge.fromParts("test", "unversioned", _collectionid, entropy = "unversioned")
        val _ = fixture.datastorespace.inject(
          DataStore.CollectionId.EntityStore(_collectionid),
