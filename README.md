...
- **Component Operation Language**  
  Defines synchronous interactions (commands, queries, request–response operations)
...
- **Cozy Modeling Language** — model-driven code generation
- **Semantic Integration Engine (SIE)** — knowledge retrieval and reasoning
- **SmartDox** — literate model-driven documentation
...
- call the framework’s public APIs
