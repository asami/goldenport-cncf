...
- Implement a user-defined custom HelloWorld Component
- The component is written as a single-file Scala program using **scala-cli**
- No build tool or project setup is required for the demo
- The **same scala-cli script** is used to run:
  - server mode
