...
Phase 77の直近ターゲットはSkill-driven Workflow SPI/Continuation runtimeである。Workflow API proxy、local/REST connectorは後続Phaseに分離する。ただしPhase 77 runtime identity/correlation/provider modelは将来のtransport-neutral Workflow connectionを阻害しないようにする。
