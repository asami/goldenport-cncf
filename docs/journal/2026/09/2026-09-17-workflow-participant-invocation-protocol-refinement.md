...
Date: 2026-09-17
Status: Design decision / Phase 77 input
...
Phase 77ではAction/Participant単位のbinding dispatch、mixed-protocol workflow、durable human continuation、stale snapshot rejection、UI/AI共通resume contractをruntime acceptanceへ追加する。
