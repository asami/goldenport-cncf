# Phase 77 Addendum: Generic Skill Workflow Support

Status: planned / normative addendum to Phase 77
...
`asami/sm-workflow` をSoftware Development specialization/reference consumerとして利用し、実運用からgeneric candidateを抽出する。ただしPhase 77 contractを`sm-workflow`固有要件へ固定しない。
