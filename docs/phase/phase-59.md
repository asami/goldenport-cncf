...
- Phase 57 resolved Resource SubComponent inventory, state, integrity, and
  provenance; and
- Phase 58 Component knowledge and model manifests.
...
Phase 57 supplies the physical Resource SubComponent resolver and Phase 58
supplies the documentation/model knowledge contract. Phase 59 is their
...
- Admin exposes Component model metadata for Entity, Powertype, StateMachine,
  ...
  state diagrams supplied by Phase 58.
...
- Present primary CAR plus Documentation and SourceCode SubComponent
  ...
  the Phase 57 resolver.
- Present Phase 58 manuals, Help, Scaladoc, source availability, model
...
| ADM-04 | Component contract and model visibility | Service, Operation, SPI, capability, schema, model types, relationships, and Phase 58 diagrams are visible without reconstruction. | planned |
...
| ADM-06 | Documentation navigation | Admin links exact manuals, Help, Scaladoc, source availability, examples, and troubleshooting resources through the Phase 58 manifest. | planned |
...
- Admin consumes the Phase 57 resolver; it does not scan physical resource
  locations independently.
- Admin consumes the Phase 58 knowledge/model manifest; it does not regenerate
...
- [Phase 57 - Component Resource SubComponent Foundation](phase-57.md)
- [Phase 58 - Component Documentation and AI Knowledge Integration](phase-58.md)
