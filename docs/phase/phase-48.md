...
| --- | --- | --- | --- |
| OE-01 | Normative contract | Design/spec fix automatic capture, SPI ownership, no-op behavior, and supplemental DSL boundaries. | active |
| OE-02 | Capture model | Typed automatic and supplemental facts have bounded stable identities and confidentiality rules. | pending |
...
| OE-07 | Diagnostics | Delivery status, limitation, CallTree, and metrics remain payload-safe and non-authoritative. | pending |
