...
- Current step: RQ-01 Contract promotion
...
Start RQ-01. Normative design/spec changes and executable provider behavior
must precede implementation adoption in CBD Support.
