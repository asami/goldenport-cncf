# Phase 60 Checklist - Information CML Runtime Canonicalization

status=planned
phase=[Phase 60 - Information CML Runtime Canonicalization](phase-60.md)
...
- [ ] Run cold CML generation and focused Phase 60 suites.
...
- [ ] Close Phase 60 only after all completion rules and documentation gates
  pass.
