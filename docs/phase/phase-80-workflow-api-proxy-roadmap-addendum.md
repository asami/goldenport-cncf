# Phase 80 Addendum: Workflow API Proxy Roadmap

Status: planned / forward-compatibility clarification

## Current Phase 80 requirement
...
Do not expand the immediate Phase 80 Skill-driven Workflow foundation to implement these connectors before the SPI/suspend/resume contract is stable.
