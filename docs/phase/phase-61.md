# Phase 61 - Web Session CSRF Unification
...
Phase 61 preserves the CSRF requirement. It closes the gap where application
...
- [Phase 61 Checklist](phase-61-checklist.md)
