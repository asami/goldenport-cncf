...
- A (ACTIVE): CW-01 — Stabilize Port / Binding / ExtensionPoint framework baseline.
- B (SUSPENDED): CW-02 — Define subsystem construction path based on bound Components.
- C (SUSPENDED): CW-03 — Validate sample-oriented wiring path and close remaining framework gaps.
...
- [ ] CW-01: Stabilize Component port/binding model and framework-level install path.
- [ ] CW-02: Define and implement subsystem construction via bound Components.
