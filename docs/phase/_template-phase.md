...
- B (SUSPENDED): DI-02 — Deploy and execute HelloWorld component using existing loader
- C (SUSPENDED): DI-03 — Document reproducible demo execution steps (article-ready)

Resume Hint:
- Complete the minimal sbt project skeleton and verify local execution.
...
- NP-001: Error taxonomy refinement
- NP-002: OpenAPI visibility control
- NP-003: Component lifecycle extension

These items were identified during Phase 2.85 but are
