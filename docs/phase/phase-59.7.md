...
BoK retrieval produces attributable exact identity handoff and preserves CBD
Support primary ownership. Phase 59.8 consumes the integrated evidence model.

## Non-Goals

CBD Support detail replacement, Phase 60 behavior, unbounded source indexing,
and final Phase closure.
