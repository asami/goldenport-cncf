# Phase 77 Addendum: StateMachine API/SPI Runtime Foundation

Status: planned / normative refinement

## Goal

Phase 77のWorkflow SPI/Continuation runtimeをStateMachine API/SPI runtimeの最初のvertical sliceとして実装し、Workflow専用の並行機構を作らない。
