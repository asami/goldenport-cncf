...
- Current step: RB-01 contract audit and scope freeze
...
- A (IN PROGRESS): RB-01 - Audit existing contracts and freeze Phase 36 scope.
- B (OPEN): RB-02 - Confirm the component execution-time contract.
