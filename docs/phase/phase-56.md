# Phase 56 - Component Documentation and AI Knowledge Integration
...
Phase 56 organizes hand-written manuals, generated Help, Scaladoc, source,
...
Phase 56 does not reopen Phase 50 Entity revision/OCC behavior. It may document
...
- Phase 56 does not make CAR embedding the primary public distribution of
  CNCF/CML/Cozy documentation.
- Phase 56 does not treat a framework Documentation Component as an
  independent source of truth; its publication generation and hashes must
  match the canonical source projection.
- Phase 56 does not make HTML scraping the preferred RAG ingestion path when
  structured SmartDox/publication projections are available.
- Phase 56 does not publish every `ai-directive` rule or raw `SKILL.md`;
...
- Phase 56 does not distribute Component documentation primarily through Maven
...
- Phase 56 does not redesign the generic CAR executable dependency mechanism
...
Phase 56 cannot close with behavior represented only in notes, journal, phase
documents, source code, or tests.

## Repository Responsibility

| Repository | Phase 56 responsibility |
| --- | --- |
...
Phase 56 is planned and must not start before Phase 55 closes.

After Phase 55 closes, begin DOC-01 with a cross-repository inventory. Preserve
