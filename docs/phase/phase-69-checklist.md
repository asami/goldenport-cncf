...
- [ ] Define canonical Job/Task/tree/attempt/timeline/Event, typed result/input, CallTree, definition snapshot, and closed reconstructible execution-descriptor records.
- [ ] Define schema versioning, canonical encoding, compatibility, migration, corruption, retention, expiry, deletion, tombstone, integrity, authorization, tenant/subject isolation, redaction, and provider responsibilities.
- [ ] Prohibit arbitrary task/object/closure/context/provider/classloader serialization at model and codec boundaries.
- [ ] Add model, codec, round-trip, migration, integrity, redaction, hostile-record, and deterministic-encoding specifications.
...
- [ ] JM69-01 and JM69-02 are DONE.
- [ ] The frozen durable-contract handoff identifies record ownership, recovery descriptor, codec/migration, authorization, retention, and every child acceptance identity.
- [ ] Phase 69.1 dependency and the exact owned child links are recorded.
